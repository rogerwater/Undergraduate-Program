...
plt.fill_between(x, reward_human - 5, reward_human + 5, alpha=0.5)
plt.plot(x, reward_sac, label='软演员-评论家方法')
plt.fill_between(x, reward_sac - 5, reward_sac + 2, alpha=0.5)
plt.plot(x, reward_basic, label='原始的选项-评论家方法')
plt.fill_between(x, reward_basic - 5, reward_basic + 5, alpha=0.5)
plt.xlabel("回合")
plt.ylabel("奖励值")
